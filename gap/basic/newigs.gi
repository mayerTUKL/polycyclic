...
BindGlobal( "DepthOfCommutator", function(coll,i,j)
	local l,n;
...
BindGlobal( "PartitionBottomUp", function(coll)
...
BindGlobal( "PartitionTopDown", function(coll)
...
BindGlobal( "PartitionOfCollector", function(coll)
...
BindGlobal( "FiniteRelationsAsMatrixPartition", function(coll, P)
...
BindGlobal( "NormalizePcElement", function(g)
	local e,d,o,ggt;
...
BindGlobal( "NewIgs", function(inU,P)
...
BindGlobal( "NewCgs", function(U,P)
